...
public class draw2 {
	...
	public void drawBuildingList(JLabel label, ArrayList<Building> buildings, int nodeNumber, Color[] colorSet){
		drawBuildingList(label,buildings,nodeNumber,colorSet,new howToColor(){
			@Override
			public Color getColor(int index, Color[] colorSet){
				return colorSet[0];
			}
    ...
    public void drawBuildingList(JLabel label, ArrayList<Building> buildings, int nodeNumber,Color[] colorSet, howToColor htc){
