...
public class AnnouncementSystem implements Element {
	...
	public AnnouncementSystem(int xCenter,int yCenter,int r, String asid){
	...
	public void render(JLabel label, Color c){
		...
		dr.draw(xLeftUpper, yLeftUpper, squareRadius, c);  
        dr.filleddraw(centerSquare[0],centerSquare[1],4,c);
	}
}
